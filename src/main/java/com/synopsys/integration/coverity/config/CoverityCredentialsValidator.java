...
public class CoverityCredentialsValidator extends CredentialsValidator {
    ...
    public void validateUsername(final ValidationResults result) {
        if (StringUtils.isBlank(getUsername())) {
            result.addResult(CredentialsField.USERNAME, new ValidationResult(ValidationResultEnum.ERROR, "No Coverity Username was found."));
        }
    }
    ...
    public void validatePassword(final ValidationResults result) {
        if (StringUtils.isBlank(getPassword())) {
            result.addResult(CredentialsField.PASSWORD, new ValidationResult(ValidationResultEnum.ERROR, "No Coverity Password was found."));
        }
    }
}
